...
import libModulate.MFSKSignal;
import libModulate.Utils;
...
public class Main {
	public static void main(String[] args) {
		...
		byte[] SampleBits = new byte[] {
				0b00000000, (byte) 0b11111111, 0b01010101, (byte) 0b10101010
		};
		byte[] SampleSymbols = new byte[] {
				1, 2, 3, 0, 0, 0, 0, 3, 2, 1, 2, 1, 2, 3, 0
		};
		...
		Sig.ModulateUnpackedRawBits(Utils.UnpackBits(SampleBits));
		...
		byte[] UnpackedSampleBits = Utils.UnpackBits(SampleBits);
